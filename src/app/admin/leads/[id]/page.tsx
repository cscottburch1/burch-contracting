    ...
    return (
      <Section padding="lg">
        <div className="text-center py-12">
          ...
          <Button variant="primary" size="md" href="/admin" className="mt-4">
            Back to Admin
          </Button>
        </div>
      </Section>
      ...
      <section className="bg-gradient-to-br from-blue-900 to-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-4">
            <Button variant="outline" size="sm" href="/admin" className="border-white text-white hover:bg-white hover:text-gray-900">
