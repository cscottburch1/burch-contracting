...
export default function PortalDashboard() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return map[status?.toLowerCase() || 'new'] || map.new;
  };

  if (loading) return <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6"><div className="text-xl text-gray-600">Loading your project...</div></div>;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-900 text-white py-10 px-6 text-center">
        <div className="flex flex-col items-center gap-4">
          {businessConfig.logo ? (
            <img src={businessConfig.logo} alt="Burch Contracting" className="h-16" />
          ) : (
            <div className="h-16 w-16 bg-white rounded-full flex items-center justify-center">
              <span className="text-blue-900 text-2xl font-bold">BC</span>
            </div>
          )}
          <div>
        ...
        {lead && (
          <>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-2xl p-8 text-center">
              ...
              <p className="text-lg">We’ll contact you within 24 hours to schedule your free consultation.</p>
            </div>
          </>
        )}
